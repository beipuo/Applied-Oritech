...
public final class AOTooltipProvider implements TooltipProvider {
    ...
    private static final ResourceLocation GRID_NODE_STATE =
            ResourceLocation.fromNamespaceAndPath(Applied_oritech.MODID, "grid_node_state");
    private static final ResourceLocation PATTERN_PROVIDER =
            ResourceLocation.fromNamespaceAndPath(Applied_oritech.MODID, "pattern_provider");
